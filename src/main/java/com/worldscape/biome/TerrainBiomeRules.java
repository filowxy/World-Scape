...
public class TerrainBiomeRules {
    ...
    private final Map<TerrainType, TerrainBiomeRule> rules = new ConcurrentHashMap<>();
    private final Map<String, Set<Holder<Biome>>> tagCache = new ConcurrentHashMap<>();
    private Registry<Biome> biomeRegistry;
    private final Map<TerrainType, List<Holder<Biome>>> allowedBiomesCache = new ConcurrentHashMap<>();
    private final Map<TerrainType, Set<Holder<Biome>>> excludedBiomesCache = new ConcurrentHashMap<>();
